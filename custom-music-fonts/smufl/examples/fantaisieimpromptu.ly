...
global = {
  \key cis \minor
  \time 4/4
  \override Staff.TextSpanner.font-size = #0
  \override Staff.DynamicTextSpanner.font-size = #0
  \override Staff.OttavaBracket.font-size = #0
}
...
partBright = \relative c'' {
  ...
  %bar 41
  \tempo "Largo"
  R1_\markup{\large \italic "pesante"} |
  \set decrescendoText = "poco dim."
  \set decrescendoSpanner = #'text
  R1\> |
  \tempo "Moderato cantabile"
  aes2\!_\markup{\large \italic "sotto voce"}( bes8\trill aes\< des ees |
  f2) aes\!->( |
  ges4 f ees f8.-> des16 |
  aes2) bes~->( |
...
lower = \relative c {
  ...
  \set Staff.beamExceptions = #'((end . (((1 . 12) . (6 6)))))
  \tupletSpan 2
